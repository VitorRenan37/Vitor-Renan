...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22/09/2025 às 16:08
...
--
-- Banco de dados: `vitor1d`
--

-- --------------------------------------------------------

--
-- Estrutura para tabela `tabela_vitor`
--

CREATE TABLE `tabela_vitor` (
  `id` int(10) NOT NULL,
...
--
-- Índices de tabela `tabela_vitor`
--
ALTER TABLE `tabela_vitor`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `tabela_vitor`
--
ALTER TABLE `tabela_vitor`
